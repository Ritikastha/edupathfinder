...
const FeatureDetail = () => {
  ...
  const handleReview = () => {
    navigate('/rateandreview', { state: { featureData } });
  };
  ...
  if (!featureData) {
    ...
    const amenitiesList = featureData.amenties?.split('.').filter(item => item.trim() !== '');
    ...
    <div>
      ...
      <div className="container-dash-fluid position-relative p-0">
        <div className="school-detail">
          ...
          <img className="img-fluid full-screen-image" src={featureData.imageUrl} alt={featureData.school} />
          </div>
            ...
            <div className="overlay">
              <div className="overlay-content">
                <div className="left-content">
                  ...
                  <small className="text-primary"><i className="fa fa-map-marker-alt me-2"></i>{featureData.location}</small>
                </div>
        ...
        <div className="description-container">
            ...
            <div className="description-section">
              ...
              <p>{featureData.transportation}</p>
            </div>
            <div className="description-section">
              <h6 className="section-title">Cafe</h6>
              <p>{featureData.cafe}</p>
            </div>
            <div className="description-section">
              <h6 className="section-title">Hostel</h6>
              <p>{featureData.hostel}</p>
            </div>
          </div>
          </div>
